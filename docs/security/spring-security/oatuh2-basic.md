...
[原文 OAuth 2.0 的一个简单解释](http://www.ruanyifeng.com/blog/2019/04/oauth_design.html)
...
oauth2.0 是一套授权机制，用于授权第三方应用，获取数据。用户授权之后产生 token，用来代替密码。 token 不同于密码，它一般是短期的，可撤销的，一般只拥有部分权限。