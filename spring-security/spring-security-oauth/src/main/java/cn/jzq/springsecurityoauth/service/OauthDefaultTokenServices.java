...
/**
 * 自定义 token 生成策略
 * 主要改写了 createAccessToken 方法， 每次获取 token 都不同。
 * 上一个 token 在指定时间内有效
 * 参考文章 https://my.oschina.net/u/3768341/blog/2998273
 */
public class OauthDefaultTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices,
